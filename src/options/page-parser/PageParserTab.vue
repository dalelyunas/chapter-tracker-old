    ...
    <div class="section leadSection">
      ...
      <div class="content">
        <p>
          ...
          following function once on relevant pages. The resulting data will be validated and
          stored.
        </p>
        <pre
          v-highlightjs
      ...
      // Page parser component goes here 
        ...
        <p>
          ...
          <code class="javascript">'ignore_parse_result'</code> if an appropriate value does not
          exist on the current page. All components will be ignored if at least one component
          returns this value.
        </p>
      </div>
    </div>
    <div class="section">
      <h3 class="title">Add Page Parser</h3>
